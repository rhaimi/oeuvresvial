...
<script src="js/bootstrap.min.js" type="text/javascript"></script>
	...
	<H1 align="center">Ajouter Oeuvre</H1>
<div class="navbar">
			<div class="navbar-inner">
				<ul class="nav">
		<li><a href="accueil.jsp">Accueil</a></li>
		<li class="active"><a href="Controleur?action=saisieOeuvreVente">Ajouter une oeuvre à vendre</a></li> 
        ...
        <form action="Controleur?action=ajouterOeuvre" method="post" name="frmModif">
            <p>
